    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
          ...
          <div class="mb-1">
            ...
            <input
              ...
              aria-describedby="login-usuario"
              tabindex="1"
              autofocus
            />
          </div>
          ...
          <div class="mb-1">
            <label class="form-label" for="select2-basic">Perfil</label>
            <select class="select2 form-select" name="perfil" id="select2-basic">
        ...
        <p class="text-center mt-2">
          <span>Você, Egresso, é novo em nossa plataforma?</span>
          <a href="{{url('registro')}}"><br>
