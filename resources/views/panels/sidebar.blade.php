...
<div
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      {{-- Inicio da configuração do menu para cada perfil --}}
      @php
      $arquivo = [ 
          1 => 'verticalMenuAdmin.json',
          2 => 'verticalMenuEgresso.json', 
      ];

      $verticalMenuJson = file_get_contents(base_path("resources/data/menu-data/{$arquivo[Auth::user()->perfil]}"));
      $verticalMenuData = json_decode($verticalMenuJson);
      $menuData = [$verticalMenuData,];
  @endphp
      {{-- Fim da configuração do menu para cada perfil --}}
