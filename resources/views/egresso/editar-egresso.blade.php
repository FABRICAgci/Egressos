...
<section class="bs-validation">
  <div class="row">
    ...
    <div class="col-md-12 col-12">
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('update-egresso', $egresso->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <a href="{{ route('index-egresso') }}" class="btn btn-outline-secondary">Voltar</a>
          </form>
        </div>
      </div>
    </div>
