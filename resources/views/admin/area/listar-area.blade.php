    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body mt-2">
          <form class="dt_adv_search" action="{{ route('index-area') }}" method="POST">
            @csrf
            <div class="row g-1 mb-md-1">
              <div class="col-md-4">
                  ...
                  class="form-control"
                  placeholder="Ex: Segurança da Informação, Suporte técnico, etc."
                  aria-label="Name"
          ...
          @if ($areas->isNotEmpty())
              @foreach($areas as $a)
                <p class="card-text">
                  ...
                  <a href="{{ route('destroy-area', $a->id) }}" onclick='return confirm("Deseja mesmo excluir {{$a->descricao}}?");'>
...
<div>
  @if (!empty($filtros)) {{$areas->appends($filtros)->links()}} @else {{$areas->links()}} @endif
</div>
