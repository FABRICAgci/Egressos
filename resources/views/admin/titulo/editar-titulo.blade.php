...
<section class="bs-validation">
  <div class="row">
    ...
    <div class="col-md-6 col-12">
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('update-titulo', $titulo->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="mb-1">
            ...
            <div class="mb-1">
              ...
              <select class="select2 form-select" name="ativo" id="select3-basic">
                <option value="1" @if($titulo->ativo == 1) selected @endif>Ativo</option>
                <option value="2" @if($titulo->ativo == 2) selected @endif>Inativo</option>
              </select>
            </div>
            <button type="submit" class="btn btn-primary me-1">Salvar</button>
            <a href="{{ route('index-titulo') }}" class="btn btn-outline-secondary">Voltar</a>
          </form>
        </div>
      </div>
    </div>
